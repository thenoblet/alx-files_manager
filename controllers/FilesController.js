...
class FilesController{
	...
	static async postUpload(request, response) {
		...
		let validParentId = parentId === '0' ? null : ObjectId(parentId);
	...
	/**
	 * Validates the file upload request by checking for missing fields like `name`, `type`, and `data`.
	 * It also verifies the validity of the `parentId` if provided.
	 *
	 * @function validateFileRequest
	 * @param {Object} request - Express request object.
	 * @param {Object} response - Express response object.
	 * @returns {Promise<Object>} An object containing validation error (if any) and the parent folder document.
	 */
